...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Cli)\n/* harmony export */ });\n/* harmony import */ var _keys_AbstractKey__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./keys/AbstractKey */ \"./src/keys/AbstractKey.js\");\n/* harmony import */ var _FileSystem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FileSystem */ \"./src/FileSystem.js\");\n/* harmony import */ var _HisotyStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./HisotyStack */ \"./src/HisotyStack.js\");\n/* harmony import */ var _TempLogStack__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TempLogStack */ \"./src/TempLogStack.js\");\n\n\n\n\n\nclass Cli {\n  constructor() {\n    this.config = {\n      CLIOutputDiv: document.getElementById('CLIOutputDiv'),\n      CLITextInput: document.getElementById('CLITextInput')\n    };\n    this.filesystem = new _FileSystem__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n    this.history = new _HisotyStack__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n    this.tempLog = new _TempLogStack__WEBPACK_IMPORTED_MODULE_3__[\"default\"]();\n    this.key = null;\n  }\n\n  implementKey = (event) => {\n    if (event.key != 'Enter' && event.key != 'ArrowUp' && event.key != 'ArrowDown') {\n      return;\n    }\n    const strategy = new _keys_AbstractKey__WEBPACK_IMPORTED_MODULE_0__[\"default\"](event.key);\n    strategy.key.call(this);\n  }\n\n  evaluatedResultsStringFromParsedCLIArray(parsedArray) {\n    return 'response from each command';\n  }\n\n  adjustTop() {\n    this.config.CLIOutputDiv.scrollTop = this.config.CLIOutputDiv.scrollHeight;\n  }\n\n  addHistory(command) {\n    this.history.push(command);\n  }\n}\n\n//# sourceURL=webpack://cli_app/./src/Cli.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ CommandNode)\n/* harmony export */ });\nclass CommandNode {\n  constructor(command) {\n    this.command = command;\n    this.next = null;\n  }\n}\n\n//# sourceURL=webpack://cli_app/./src/CommandNode.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ FileSystem)\n/* harmony export */ });\nclass FileSystem {\n  pwd() {\n    return '/dir/file'\n  }\n}\n\n//# sourceURL=webpack://cli_app/./src/FileSystem.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ HistoryStack)\n/* harmony export */ });\n/* harmony import */ var _CommandNode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CommandNode */ \"./src/CommandNode.js\");\n\n\nclass HistoryStack {\n  constructor() {\n    this.head = null;\n  }\n\n  push(command) {\n    const temp = this.head;\n    this.head = new _CommandNode__WEBPACK_IMPORTED_MODULE_0__[\"default\"](command);\n    this.head.next = temp;\n  }\n\n  peek(){\n      if(this.head == null) return null;\n      return this.head.command;\n  }\n\n  pop(){\n    const temp = this.head;\n    if (temp == null) {\n      return;\n    }\n    this.head = this.head.next;\n    return temp.command;\n  }\n}\n\n//# sourceURL=webpack://cli_app/./src/HisotyStack.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ TempLogStack)\n/* harmony export */ });\n/* harmony import */ var _CommandNode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CommandNode */ \"./src/CommandNode.js\");\n\n\nclass TempLogStack {\n  constructor() {\n    this.head = null;\n  }\n\n  push(command) {\n    const temp = this.head;\n    this.head = new _CommandNode__WEBPACK_IMPORTED_MODULE_0__[\"default\"](command);\n    this.head.next = temp;\n  }\n\n  peek(){\n      if(this.head == null) return null;\n      return this.head.command;\n  }\n\n  pop(){\n      let temp = this.head;\n      this.head = this.head.next;\n      return temp.command;\n  }\n}\n\n//# sourceURL=webpack://cli_app/./src/TempLogStack.js?");
